...
if (prevArrow) {
	prevArrow.addEventListener('click', function () {
		var sliderActive = document.querySelector(
			'.slider-block .slider-main .slick-list .slick-active'
		);
		var img = sliderActive.querySelector('.bg-img img');
		var heading = sliderActive.querySelector('.text-content .heading3');
		...
		var images = document.querySelectorAll('.slider-item .bg-img img');
		var headings = document.querySelectorAll('.text-content .heading3');
...
// our project home2
if ($('.our-project-block .list-project .row').length) {
...
// testimonials home2
if ($('.testimonials-block .container .list-comment').length) {
...
// case studies home3
if ($('.case-studies-block.style-two.style-three .container .row').length) {
...
// testimonials home3
if ($('.testimonials-three .container .list-comment').length) {
...
// testimonials home4
if ($('.testimonials-four .container .row').length) {
...
// testimonials home6
if ($('.testimonials-six .container>.row').length) {
