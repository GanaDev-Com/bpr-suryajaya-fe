			...
			<div class="col-12 col-xl-4 col-lg-6 col-md-6 col-sm-6">
				<div class="service-item hover-box-shadow bora-8 p-32 bg-white border-line-1px">
					<a class="service-item-main flex-column gap-16" href="#!">
						...
						<div class="desc">
							<div class="heading7 hover-text-blue">Kredit Modal Kerja Dengan Setoran Pokok</div>
					...
					<a class="service-item-main flex-column gap-16" href="#!">
						...
						<div class="desc">
							<div class="heading7 hover-text-blue">
								Kredit Modal Kerja Dengan Dengan Sistem Angsuran
							</div>
							<div class="body4 text-secondary mt-4">
								<div class="more-infor mt-24">
									<div class="infor flex-item-center gap-12">
			...
			<div class="col-12 col-xl-4 col-lg-6 col-md-6 col-sm-6">
				<div class="service-item hover-box-shadow bora-8 p-32 bg-white border-line-1px">
					<a class="service-item-main flex-column gap-16" href="#!">
						...
						<div class="desc">
							<div class="heading7 hover-text-blue">
								Kredit Modal Kerja Tarik Setor ( REKENING KORAN )
							</div>
							<div class="body4 text-secondary mt-4">
								<div class="more-infor mt-24">
									<div class="infor flex-item-center gap-12">
			...
			<div class="col-12 col-xl-4 col-lg-6 col-md-6 col-sm-6">
				<div class="service-item hover-box-shadow bora-8 p-32 bg-white border-line-1px">
					<a class="service-item-main flex-column gap-16" href="#!">
						...
						<div class="desc">
							<div class="heading7 hover-text-blue">Kredit Konsumtif</div>
							<div class="body4 text-secondary mt-4">
								<div class="more-infor mt-24">
									<div class="infor flex-item-center gap-12">
										<CheckCircle width="15" height="15" class="text-blue" />
