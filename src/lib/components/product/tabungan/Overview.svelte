<script lang="ts">
	...
	import Tabungan from '$lib/images/product/tabungan.webp';
</script>
	...
	<div class="container">
		<div class="row row-gap-32 column-reverse-xl">
			<div class="col-12 col-xl-6 flex-columns-between row-gap-20 pr-40">
				<div class="heading4">Bunga Kompetitif, Pilihan Tabungan Fleksibel</div>
				<div class="body3 text-secondary text-justify pb-100">
					Beragam produk tabungan dengan bunga kompetitif dirancang untuk memenuhi kebutuhan Anda.
					Cocok untuk keperluan pribadi maupun usaha, solusi keuangan ini siap membantu Anda
					mengelola dan mengembangkan simpanan dengan lebih maksimal.
