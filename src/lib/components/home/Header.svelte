<script lang="ts">
	...
	import Slider1 from '$lib/images/slider/slider1.webp';
	import Slider2 from '$lib/images/slider/slider1-1.webp';
	import Slider3 from '$lib/images/slider/slider1-2.webp';
</script>
...
<div class="slider-block style-one">
	...
	<div class="slider-main">
		<div class="slider-item slider-first">
			<div class="bg-img">
				<img
					...
					src={Slider1}
					alt="Solusi Keuangan Terpercaya"
				/>
			</div>
			<div class="container">
		...
		<div class="slider-item slider-second">
			<div class="bg-img">
				<img loading="lazy" class="w-100 h-100" src={Slider2} alt="Keamanan Transaksi" />
			</div>
			<div class="container">
				<div class="text-content flex-columns-between">
					<div class="heading3">
		...
		<div class="slider-item slider-third">
			<div class="bg-img">
				<img loading="lazy" class="w-100 h-100" src={Slider3} alt="Impian Anda" />
			</div>
			<div class="container">
				<div class="text-content flex-columns-between">
					<div class="heading3">
