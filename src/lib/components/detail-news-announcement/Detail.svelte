				...
				<div class="blog-paragraph">
					<div class="paragraph-heading text-center">
						<div class="bg-img mt-40">
							<img class="w-100 bora-16" src={Blog1} alt="" />
						</div>
					</div>
					<div class="paragraph-content mt-32">
						...
						<div class="review p-12 mt-16">
							<div class="body2">
								“ Seize control of your financial future and unleash your potential for success. Our
								expert guidance will empower you to navigate the intricacies of financial
								management. From budgeting and saving to investing and debt management, we provide
								the tools and knowledge you need to achieve your goals.”.
							</div>
							<ul>
								<li class="fs-12 fw-700 mt-16">Tony Nguyen, CEO of Avitex</li>
							</ul>
						</div>
					</div>
					<div class="image-center row mt-32">
						<div class="col-6">
							<img class="w-100 bora-12" src={Blog2} alt="" />
						</div>
						<div class="col-6">
							<img class="w-100 bora-12" src={Blog3} alt="" />
						</div>
					</div>
					<div class="paragraph-content mt-32">
						<div class="heading6">How to Saving Finacial</div>
						<div class="body2 text-secondary mt-16">
				...
				<div class="blog-more-infor mt-32">
					<div class="infor-above flex-between">
						<div class="tags-cloud-block flex-item-center gap-12">
							<div class="body3">Tag(s):</div>
							<div class="list-nav flex-item-center gap-12">
								<a
									class="caption2 pt-8 pb-8 pl-16 pr-16 bg-surface bora-20 hover-button-black"
									href="#!">Featured</a
								><a
									class="caption2 pt-8 pb-8 pl-16 pr-16 bg-surface bora-20 hover-button-black"
									href="#!">Interview</a
