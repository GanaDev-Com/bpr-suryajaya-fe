	...
	<div class="container">
		<div class="row row-gap-32 column-reverse-xl">
			<div class="col-12 col-xl-6 flex-columns-between row-gap-20 pr-40">
				<div class="heading4">Berbagai Produk dan Promo Bunga Kredit Bulan Ini</div>
				<div class="body3 text-secondary text-justify">
					Nikmati penawaran bunga kredit terbaik bulan ini di BPR Suryajaya Kubutambahan. Solusi
					kredit yang fleksibel dan terjangkau untuk memenuhi kebutuhan pribadi atau usaha Anda.
					Segera ajukan dan wujudkan impian finansial Anda bersama kami!
				</div>
			...
			<div class="col-12 col-xl-6">
				<div class="bg-img w-100 overflow-hidden bora-20">
					<img
						...
						src="/assets/images/product/kredit.jpeg"
						alt="Promo Kredit"
					/>
				</div>
			</div>
