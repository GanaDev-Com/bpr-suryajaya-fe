<div class="financial-assessment-block service-block pt-80 bg-white">
	<div class="container list-service">
		<div class="row flex-item-center">
			...
			<div class="col-12 col-xl-7 col-lg-7 flex-column">
				...
				<div class="nav-infor ml-40 mt-40">
					<div class="list-nav flex-item-center gap-40">
						<div class="nav-item active" data-name="about-us">Simulasi Kredit</div>
						<div class="nav-item" data-name="mission">Simulasi Tabungan</div>
						<div class="nav-item" data-name="vision">Simulasi Deposito</div>
					</div>
