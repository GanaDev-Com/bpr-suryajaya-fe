<div class="slider-sub">
	...
	<div class="container">
		<div class="heading-nav gap-4 mt-32">
			...
			></i>
			<a class="hover-underline caption1 text-white" href="/support">Bantuan</a><i
				class="ph ph-caret-double-right text-white"
			></i>
			<div class="caption1 text-white">Pusat Bantuan</div>
		</div>
		<div class="text-nav">
			<div class="heading3 text-white">Pusat Bantuan</div>
